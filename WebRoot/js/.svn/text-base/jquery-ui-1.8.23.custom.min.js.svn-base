...
$.extend(Datepicker.prototype, {
  ...
  _clearDatepicker: function (input) {
    this._curInst.input.val("");
  },
  ...
  _attachHandlers: function(inst) {
    ...
    inst.dpDiv.find('[data-handler]').map(function () {
      var handler = {
        ...
        //清空
        clear: function () {
          window['DP_jQuery_' + dpuuid].datepicker._clearDatepicker();
        },
        today: function () {
  ...
  _generateHTML: function(inst) {
    ...
    var buttonPanel = (showButtonPanel) ? '<div class="ui-datepicker-buttonpane ui-widget-content">' + (isRTL ? controls : '') +
     // (this._isInRange(inst, gotoDate) 
      (1 ? '<button type="button" class="ui-datepicker-current ui-state-default '+
      'ui-priority-primary ui-corner-all" data-handler="clear" data-event="click">清空</button>' : '') + (isRTL ? '' : controls) + '</div>' : '';
